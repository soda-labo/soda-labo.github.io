...
<a href="/publications/"><span class="label label-bias-fairness-selected">bias/fairness</span></a> 
<a href="/publications/user"><span class="label label-user-engagement">user engagement</span></a> 

{%- assign target_tag = 'bias/fairness' -%}

{% assign number_printed = 0 %}
{% for publi in site.data.publist %}

{% assign even_odd = number_printed | modulo: 2 %}
{% if publi.highlight == 1 and publi.tags contains target_tag%}
...
{% for publi in site.data.publist %}
  {%if publi.tags contains target_tag%}
