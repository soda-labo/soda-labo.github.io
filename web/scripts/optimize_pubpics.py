...
TARGET_SIZE×TARGET_SIZE, and re-encodes with reasonable compression.
...
Supports: JPG/JPEG, PNG, WebP, GIF (first frame only).
"""
import json
import sys
    ...
    for path in files:
        ...
        try:
            with Image.open(path) as img:
                ...
                if already_square and already_small_enough and cached.get("optimized") is True:
